...
if __name__ == "__main__":
    ...
    parser.add_argument("method", default='tsili', help="Name of the method to evaluate, 'compass', 'opga' or 'tsili'")
    parser.add_argument("datasets", default='data/op/op100_const_validation_seed4321.pkl', help="Filename of the dataset(s) to evaluate")
